        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 text-uppercase text-bold">Product Stock</h4>
                </div>
                <div class="card-body">
                    ...
                    <table v-if="!loader && ProductCollections.data.length > 0"
                        ...
                        <tr v-for="(product,index) in ProductCollections.data" :key="index">
                            ...
                            <td class="align-middle"><img
                                ...
                                :src="base_url+'/uploads/products/tiny/'+product.image" alt=""></td>
...
export default {
    ...
    methods: {
        ...
        showStockHistory(page=1,loader_status) {
            ...
            axios.get(`${this.base_url}/admin/get_stock_history/${this.currentProductData.id}?per_page=${this.history_per_page}&page=${page}`)
                .then(({data}) => {
