...
@section('content')
  ...
  <div class="row">
    <div class="col-lg-12">
        ...
        <div class="p_wrapper">
          <div class="row">
            <div class="col-lg-4"><a href="{{route('sales_invoice.index')}}" class="btn btn-sm btn-warning"><i class="fa fa-angle-left"></i> back</a></div>
            <div class="col-lg-8">
...
var salestoreurl = '{{route('sales_invoice.store')}}';
