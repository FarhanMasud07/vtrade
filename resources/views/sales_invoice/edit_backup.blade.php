...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="p_wrapper">
                <div class="row">
                    <div class="col-lg-4"><a href="{{route('sales_invoice.index')}}" class="btn btn-sm btn-warning"><i
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <span class="float-left"><b>RESET FIELDS</b></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="free" id="free" placeholder="Enter Free"
                                   value="0">
                ...
                <div class="row">
                        ...
                        <div style="border: 1px solid #ddd;padding: 30px;border-radius: 10px">
                            ...
                            <div class="onoffswitch">
                                <input type="checkbox" class="onoffswitch-checkbox" id="is_condition" value="1"
                                       @if($sale->is_condition == true) checked @endif>
                            ...
                            <input type="text" class="form-control mt-3" id="condition_amount"
                                   placeholder="Enter Condition Booking Amount" value="{{round($sale->condition_amount)}}">
                        </div>
                    </div>
                    <div class="col-lg-5" id="amount-info">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Discount (%) <input type="number" class="form-control tiny-input"
                                                        id="discount_input" value="0"></td>
                                <td>Discount Amount <input type="text" class="discount form-control"
                                                           value="{{round($sale->discount)}}"></td>
                            </tr>
                            <tr>
                                <td>Net Amount</td>
                            ...
                            <tr>
                                <td>Carrying & Loading <input type="number" class="form-control tiny-input"
                                                              id="carrying_and_loading"
                                                              value="{{round($sale->carrying_and_loading)}}"></td>
                        ...
                        <button type="button" class="btn btn-warning" id="confirm-btn" onclick="confirm_sales()">
                            Update
                        </button>
        ...
        @push('js')
            ...
            <script>
                ...
                axios.get('{{route('saleinfo.api',$sale->id)}}')
                .then( (res) => {
                    if (sessionStorage.saleId == undefined) {
                        sessionStorage.setItem('salesCart', JSON.stringify(res.data.salesCart));
                        sessionStorage.setItem('user_id', res.data.user_id);
                        sessionStorage.setItem('sales_date', res.data.sales_date);
                        sessionStorage.setItem('saleId', res.data.sale_id);
                        location.reload(true);
                    } else if (sessionStorage.saleId != res.data.sale_id) {
                ...
                var salesupdateurl = '{{route('sales_invoice.update',$sale->id)}}';
