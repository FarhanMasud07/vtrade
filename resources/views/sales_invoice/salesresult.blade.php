        ...
        <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-lg-8">
                    <a href="{{route('sales_invoice.create')}}" class="btn btn-info btn-sm float-right"><i class="fa fa-plus"></i> New Sales Invoice </a>
                </div>
            </div>
            </div>
            <div class="card-body">

              <form action="{{route('sales_invoice.result')}}" method="POST">
                @csrf
              ...
              <table class="table" id="jq_datatables">
                ...
                <tbody>
                    ...
                    @if($item->deleted_at == NULL)
                      <td ><a class="btn btn-info btn-sm" target="_blank" href="{{route('sales_invoice.show',$item->id)}}"><i class="fa fa-eye"></i></a> <a target="_blank" class="btn btn-primary btn-sm" href="{{route('sales_invoice.edit',$item->id)}}"><i class="fa fa-edit"></i></a>
                      </td>
                    @else
