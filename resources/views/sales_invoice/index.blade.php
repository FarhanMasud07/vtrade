                          ...
                          <tbody>
                              ...
                              @if($item->deleted_at == NULL)
                                ...
                                @can('sales_invoice.edit')
                                  <a class="btn btn-info btn-sm" target="_blank" href="{{route('sales_invoice.show',$item->id)}}"><i class="fa fa-eye"></i></a>   | <a target="_blank" class="btn btn-primary btn-sm" href="{{route('sales_invoice.edit',$item->id)}}"><i class="fa fa-edit"></i></a>
                                  @endcan
                                </td>
                              @else
