                        ...
                        <div class="invoice p-3 mb-3">
                                    ...
                                    @if(Route::current()->getName() == 'viewsales.show')
                                        ...
                                        <a href="{{route('admin.inventorydashboard')}}"
                                           class="btn btn-info btn-sm mb-5"><i class="fa fa-angle-left"></i> back to
                                            dashboard</a>
                                    @else
                                        <a href="{{route('sales_invoice.index')}}" class="btn btn-info btn-sm mb-5"><i
                                    ...
                                    @if($sale->sales_status == 0)
                                        ...
                                        @endcan
                                            ...
                                            <form id="delete-from-{{$sale->id}}"
                                                  action="{{route('sales_invoice.destroy',$sale->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="row no-print">
                                ...
                                <div class="col-6">
                                    ...
                                    <form action="{{route('sales_invoice.invoice',$sale->id)}}" method="POST">
                                        @csrf
