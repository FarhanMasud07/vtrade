        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="mt-3 mb-5 text-uppercase text-center">Last 10 Cashes</h3>
            ...
            axios.get(last10cashurl)
                .then(res => {
                    ...
                    data.forEach(function (data, key) {
                        if(edit_permission){
                            edit_btn = `<a class="btn btn-warning btn-sm"  onclick="editCashModalInitiate(${data.id})"  href="javascript:void(0)"><i class="fas fa-edit"></i></a>|`;
                        }
                      ...
                      <td class="align-middle" style="width: 12%"> ${edit_btn}
 <a class="btn btn-info btn-sm"  href="${baseUrl}/admin/pos/cash/${data.id}"><i class="fas fa-eye"></i></a>
</td>
                    </tr>`;
                    });
