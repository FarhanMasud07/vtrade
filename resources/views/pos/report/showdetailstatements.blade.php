                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle">{{round($item['debit'])}}</td>
                          <td class="align-middle">{!! $item['particular'] === 'cash' ?
round($item['discount']) > 0 ?
'paid: '.round($item['credit']-$item['discount']).'<br> Discount: '.round($item['discount']).' <br>actual: '.round($item['credit'])  : round($item['credit'])
: round($item['credit'])
!!}</td>
                          <td>
                          @php
