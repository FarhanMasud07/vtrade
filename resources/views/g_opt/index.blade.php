                ...
                <div class="card-body p-5">
                    <form action="{{route('generaloption.update',$g_opt->id)}}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100">
                                <div class="form-group">
                                    <label for="featured_product_for_invoice">Featured products for all invoice</label>

                                    <select class="w-100" name="featured_product_for_invoice[]"
                                            id="featured_product_for_invoice" multiple>
                                        @foreach($products as $product)
                                            <option value="{{$product->id}}"
                                                @if(count($g_opt_value['featured_product_for_invoice']) > 0)
                                                @foreach($g_opt_value['featured_product_for_invoice'] as $product_id)
                                                @if((int) $product_id === (int) $product->id)
                                                    selected @endif
                                            @endforeach
                                            @endif
                                            >{{$product->product_name}} - {{($product->size->name)}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="w-100 text-center mb-3"><h4>Challan Note</h4></div>
                            <div class="mb-4">
                                <label for="challan_note_image">Challan Note Image</label>

                                <div><input type="file" class="form-control" name="challan_note_image">
                                    @isset($g_opt_value['challan_note_image'])
                                        <p class="text-danger text-bold my-3">NOTE: Image ratio will be 792x261</p>
                                    <img style="width: 60%"
                                         src="{{asset('uploads/'.$g_opt_value['challan_note_image'])}}"
                                         alt="">
                                    @endisset
                                </div>
                                ...
                                {{--<textarea id="challan_note"
                                          rows="10"
                                          name="challan_notes"
                                          class="form-control"
                                          placeholder="Write Challan Note which will shows on the challan">@isset($g_opt_value['challan_notes']) {{$g_opt_value['challan_notes']}} @endisset</textarea>--}}
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div>Product Return Invoice Created <span class="badge badge-danger">Admin e-mail</span></div>
                                <div>
                                    <label class="switch">
                            ...
                            <div class="admin_email_return_invoice_created_wrapper subsection_wrapper mb-3"
                                 ...
                                 @else style="display: none" @endif
                            >
                                <div class="mb-3">Select Some Admin for <b>Product Return Invoice Created </b> mail Notification
                                </div>
                                <div>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <div>Product Return Invoice Edited <span class="badge badge-danger">Admin e-mail</span></div>
                                <div>
                                    <label class="switch">
                            ...
                            <div class="admin_email_return_invoice_edited_wrapper subsection_wrapper mb-3"
                                 ...
                                 @else style="display: none" @endif
                            >
                                <div class="mb-3">Select Some Admin for <b>Product Return Invoice Edited</b> mail Notification
                                </div>
                                <div>
...
@push('js')
    <script>
        ...
        $("#featured_product_for_invoice").select2({
            width: '100%',
        });
