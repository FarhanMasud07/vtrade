...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/login_new.css').'?v='.config('custom_variable.asset_version')}}">
</head>
<body>
                ...
                <div class="wrap">
                    <div class="py-2 px-4">
                        <div class="w-100 text-center py-3">
                           ...
                           <h4 class="w-100 text-center text-uppercase pb-3">Admin Login</h4>
