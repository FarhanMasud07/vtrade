                ...
                @endif
                  ...
                  <div class="statement_table">
                    ...
                    <table class="table table-sm">
                       ...
                       $sum = $sum+($item['amount']-$item['discount']);
                  $discountTotal = $discountTotal+$item['discount'];
                        ...
                        <tr>
                          ...
                          <td style="width: 80px"  class="align-middle" >{{ $userinfo->address}}</td>
                            <td  class="align-middle">{!! round($item['discount']) > 0 ?
'Paid: '.round($item['amount']).'<br> Discount: '.round($item['discount'])  : round($item['amount']) !!}</td>
