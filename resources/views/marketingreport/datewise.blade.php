                ...
                <table class="table" id="jq_datatables">
                    ...
                    <tbody>
                        ...
                        @foreach ($marketingreport as $key => $item)
                            ...
                            <td>{{$item->delivery}}</td>
                            <td>{{$item->market}}</td>
                            <td><a  class="btn btn-warning btn-sm" href="{{route('marketingreport.edit',$item->id) }}"><i class="fas fa-edit"></i></a> @can('Edit Marketing Report') <form action="{{route('marketingreport.destroy',$item->id) }}" method="POST" style="display: inline-block">
                            @csrf
                            @method('DELETE')
