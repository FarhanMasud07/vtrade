...
class CashController extends Controller
{
    ...
    public function approve(Request $request, $id)
    {
        ...
        if ($cash->status == 1) {
            ...
            if ($g_opt_value['customer_cash_approval_notify'] == true && $customer_sms_number != null) {
                if ($cash->received_at->diffInDays(now()) < $max_days_delay_for_allowing_sms) {
                    $customer_sms_text = "We received your amount BDT " . $cash->amount . " posting date:  " . $cash->received_at->format('d-M-Y') . " Reference: " . $cash->reference . "  Thanks (" . $this->company_name . ")";
